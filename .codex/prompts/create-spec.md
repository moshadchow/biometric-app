...
Always follow the rules in AGENTS.md and the current eKYC regulatory requirements.
...
- `.codex/prompts/` — avoid duplicate implementation
...
Always verify against `core/db.py` before writing this.
...
Save to:
`.codex/prompts/<step_number>-<feature_slug>.md`

## Step 9 — Report to the user
Print a short summary in this exact format:
```
Branch:    <branch_name>
Spec file: .codex/prompts/<step_number>-<feature_slug>.md
Title:     <feature_title>
